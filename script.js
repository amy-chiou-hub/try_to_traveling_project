...
function initMap() {
  ...
  map = new google.maps.Map(document.getElementById("map"), {  // ✅ 改成這樣
    zoom: 15,
    center: location,
  });
...
async function getWeather(city) {
  const apiKey = "AIzaSyBzYH3TIWNaRH19B0sABxiFQA-H7XrOoZI"; // API KEY
...
async function getAISuggestion(city, weather) {
  ...
  const response = await fetch(
    "https://generativelanguage.googleapis.com/v1beta/models/gemini-pro:generateText?key=AIzaSyBzYH3TIWNaRH19B0sABxiFQA-H7XrOoZI",
    {
      method: "POST",
